...
function AimMasterPage() {
  ...
  return <div className="app-page">
    ...
    <div className="aim-readiness-strip"><Badge tone="success">A + TARGETS + C1/C2 LIVE</Badge><span>Lead capture, communication, meetings, C1 and C2 actuals are live from MongoDB. C3/C4 commercial actuals connect in Phase 6.</span></div>
